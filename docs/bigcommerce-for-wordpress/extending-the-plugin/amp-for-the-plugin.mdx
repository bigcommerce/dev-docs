...
<Callout type="warning">
  Google AMP is deprecated as of January 2023. We will continue to support existing retailers who use Google AMP, however new retailers won't have the ability to implement it. Stay up-to-date with the latest details around this effort in our [Developer Changelog](https://developer.bigcommerce.com/changelog#).
</Callout>
