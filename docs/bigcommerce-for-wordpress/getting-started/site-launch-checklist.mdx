...
<Steps>
### Check your WP CLI
Ensure that your host has [WP-CLI](https://wp-cli.org/) installed and configured to manage your WordPress site.
...
### Disable WP cron
Set a constant in `your wp-config.php`:
`define( 'DISABLE_WP_CRON', true );`

### Enable WP cron events
Set up a system cron job to run WordPress's cron events from the command line:
