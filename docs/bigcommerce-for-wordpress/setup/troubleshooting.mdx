...
<Callout type="info">
  Sometimes errors don't appear in the BigCommerce for WordPress plugin logs but they can still affect the plugin. If you have exhausted your error log searches then it's suggested that you also enable server error logs. You can usually find these settings in your server's control panel or admin dashboard.
</Callout>
