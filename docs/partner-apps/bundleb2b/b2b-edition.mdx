...
If your development sandbox or retailer store didn't come with B2B Edition pre-installed, reach out to your BigCommerce representative. You can also download the app from the [B2B Edition information page](https://www.bigcommerce.com/apps/b2b-edition/) in the Apps Marketplace.
