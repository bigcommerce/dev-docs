...
Use the [Channel Assignments API](/docs/rest-management/catalog/products-channel-assignments#get-products-channel-assignments) to create and manage product assignments for [storefronts and other sales channels](/api-docs/multi-storefront/overview#channels).
...
Removing a product from a category does not remove it from the channel. Use the [Channel Assignments API](/docs/rest-management/catalog/products-channel-assignments#get-products-channel-assignments) to revoke channel assignments.
