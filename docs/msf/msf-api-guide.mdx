...
If your application interacts with shoppers, you can use the [GraphQL Storefront API: Carts and Checkout](https://developer.bigcommerce.com/api-docs/storefront/graphql/carts-and-checkout) to access cart and checkout data for shoppers in real time.
