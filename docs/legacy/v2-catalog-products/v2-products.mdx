...
| rules | resource | Rules that apply only to this product, based on the product's [option set](/legacy/v2-catalog-products/v2-option-sets). See [Product Rules](/archive/store-operations/v2-catalog-products/v2-product-rules) resource for information. |
