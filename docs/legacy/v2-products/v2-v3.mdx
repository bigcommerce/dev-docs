...
```json filename="GET https://api.bigcommerce.com/stores/{store_hash}/v3/catalog/products/{product_id}/options" showLineNumbers
...
```json filename="PUT https://api.bigcommerce.com/stores/{store_hash_/v3/catalog/products/{product_id}/options/{option_id}/values/{option_value)" showLineNumbers
{
	"label": "Small T-Shirt"
}
```
&nbsp;
```json filename="Response PUT https://api.bigcommerce.com/stores/{store_hash_/v3/catalog/products/{product_id}/options/{option_id}/values/{option_value)" showLineNumbers
{
    "data": {
        "id": 214,
        "label": "Small T-Shirt",
