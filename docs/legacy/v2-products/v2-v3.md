...
### On This Page
- [V2 versus V3 API](#V2-versus-V3-API)
    - [On This Page](#On-This-Page)
  - [Advantages of V3 over V2](#Advantages-of-V3-over-V2)
  - [Products in V3](#Products-in-V3)
    - [Variants](#Variants)
    - [V2 SKU rules will override Variant pricing](#V2-SKU-rules-will-override-Variant-pricing)
    - [Options and Modifiers](#Options-and-Modifiers)
  - [Interoperability between V2 and V3](#Interoperability-between-V2-and-V3)
    - [Update Request to Product Option Values](#Update-Request-to-Product-Option-Values)
      - [Size and Color](#Size-and-Color)
      - [Size and Color](#Size-and-Color-1)
  ...
  - [Simple Product](#Simple-Product)
    ...
    - [Create Product with Images](#Create-Product-with-Images)
...
V3 includes an endpoint for creating a [Catalog Tree](api-reference/store-management/catalog).
