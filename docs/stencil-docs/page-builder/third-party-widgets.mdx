...
To use this method, you will need to create an API accounts with the OAuth content scope set to `modify`. For information about creating API accounts, see the [Guide to API Accounts](/api-docs/getting-started/api-accounts).  After creating the API account, you can use its access token to inject, list, and remove widgets on any page of the store. To learn how to complete these actions, see the [Widgets Tutorial](/api-docs/storefront/widgets/widgets-tutorial).
