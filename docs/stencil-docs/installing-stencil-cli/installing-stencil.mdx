...
# Install Windows C++ Build Tools (also installs python3)
...
* [Python 3.11](https://www.python.org/downloads/) - required to build some dependencies
* [Node.js 18.15.0 and npm](https://nodejs.org/en/download/releases/)
* [Visual C++ Build Tools 2019](https://www.npmjs.com/package/windows-build-tools) - required to compile some dependencies
