...
It's because you have an old version of stencil CLI included in package.json. In general, it shouldn't be part of package.json (nor part of dev dependencies).
