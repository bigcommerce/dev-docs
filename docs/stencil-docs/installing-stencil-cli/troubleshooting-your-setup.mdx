...
### old version of `stencil-cli` included in package.json
...
You may see those errors, because your theme had some missing properies in translations, frontmatter, that become required.
...
, which indicates that `schemaTranslations.json` has missing missing translation key `i18n.HeaderAndFooter`.
...
Error: Error: Found unallowed trailing symbol in: "4,", while parsing frontmatter at ".....templates/pages/home.html".
```
