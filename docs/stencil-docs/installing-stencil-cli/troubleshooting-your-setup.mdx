...
You may see those errors because your theme has some missing properties in translations, frontmatter, that have become required.

For example, running on the theme `stencil bundle` may result in the following error:
