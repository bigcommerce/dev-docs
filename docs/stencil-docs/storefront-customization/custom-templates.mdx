...
```json title="customLayouts properties config.stencil.json" lineNumbers copy
"customLayouts": {
    "product": {},
    "brand": {},
    "category": {},
...
```json title="Populate product key" lineNumbers copy
"product": {
...
```json title="Populated brand, page, and category keys" lineNumbers copy
{
...
```json title="Map multiple URLs" lineNumbers copy
  "customLayouts": {
    "product": {
