...
1. First, create a `custom` subdirectory in the `templates/pages` directory. 
2. Then, create the following four subdirectories under the `templates/pages/custom` directory: 
...
3. Next, create the template file in .html format, and then place the file in the appropriate `templates/pages/custom/` subdirectory.
