...
The Stencil framework allows theme developers and retailers to assign custom layout templates to storefront pages. You can assign custom templates to the following storefront page types:
...
After a new theme has been uploaded to BigCommerce, the retailer (or any authorized store user) can assign the custom templates to individual store pages in the BigCommerce control panel to make it live on the storefront.
...
* [Blueprint and Developer Mode](https://developer.bigcommerce.com/legacy/blueprint-themes/blueprint-and-developer-mode)
