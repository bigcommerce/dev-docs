...
You can add front matter directly to a custom template. For more information on using front matter, see [Using Front Matter](https://bigcommerce-dev-center.netlify.app/stencil-docs/storefront-customization/using-front-matter) 
...
Before you can apply your custom template to pages you need to bundle and push the theme to BigCommerce. For detailed instructions, see [Bundling and Pushing a Theme](https://bigcommerce-dev-center.netlify.app/stencil-docs/deployment/bundling-and-pushing).
