...
The theme-wide composite image represents your theme in a non-active MSF BigCommerce control panel's **Storefront** › **Themes**, which shows retailers their currently available themes, including any custom uploaded themes.
...
Each variation within your theme must be represented by two additional screenshots if you want that variation to appear in a non-active MSF control panel's  **Storefront** › **Theme Marketplace**, which shows retailers the themes that are available for download.
