...
For error codes that you might encounter when uploading a theme – and corresponding workarounds, see [Troubleshooting Theme Uploads](/stencil-docs/installing-stencil-cli/troubleshooting-your-setup).
