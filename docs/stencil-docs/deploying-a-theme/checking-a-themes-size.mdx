...
If you have used WebDAV in developing BigCommerce's Blueprint generation of themes, you will see some differences when uploading Stencil themes. Depending on the type of theme that is active in the retailer's store, the directories accessible through WebDAV will change as shown in the table below.
