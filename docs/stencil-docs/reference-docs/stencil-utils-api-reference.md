...
The `config` argument works like front matter: it encapsulates JSON. For a usage example of `config`, see the [Remote API Example](https://bigcommerce-dev-center.netlify.app/stencil-docs/javascript-and-event-hooks/remote-api-tutorial#remote-api-example).
