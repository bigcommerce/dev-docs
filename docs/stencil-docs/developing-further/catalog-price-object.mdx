...
This display setting affects how values are returned in the catalog price object and how the values appear on storefront pages.
 ...
 ![Configure tax display settings](https://storage.cloud.google.com/bigcommerce-production-dev-center/images/tax-settings.png " Configure tax display settings. ")
