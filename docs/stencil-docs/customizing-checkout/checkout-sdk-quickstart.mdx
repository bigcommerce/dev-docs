...
The Checkout SDK is a JavaScript library of methods for performing actions related to checkout. It includes methods for logging in a customer, adding addresses to the checkout object, and surfacing the shipping and payment methods a retailer configures. It’s everything you need to build your own custom checkout page on BigCommerce.
...
* The theme should be set up for [local development](/stencil-docs/installing-stencil-cli/installing-stencil). Use Stencil CLI to preview your local changes.
