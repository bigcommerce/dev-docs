...
* The theme should be set up for [local development](/stencil-docs/installing-stencil-cli/installing-stencil). Use Stencil CLI to preview your changes.
...
In the developer console, you will see the entire available cart object. The output will look like this:
