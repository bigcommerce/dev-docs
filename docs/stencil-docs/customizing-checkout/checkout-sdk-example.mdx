...
```shell  showlineNumbers copy filename="Install dependencies"
...
```js showlineNumbers copy filename="Add objects to the 'rules' array"
{
  test: /\.jsx$/,
...
```js showlineNumbers copy filename="Add property to 'resolve' object"
extensions: ['.js', '.jsx']
```
