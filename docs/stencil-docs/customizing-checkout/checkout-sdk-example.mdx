...
```
<Callout type="info">
Comparing the content of this newly created file and the code from the [Getting Started with Checkout SDK](/docs/stencil-docs/customizing-checkout/checkout-sdk-quickstart#installing-the-checkout-js-sdk), you should see a clear resemblance between the two.
</Callout>
