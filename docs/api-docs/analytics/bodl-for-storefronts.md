...
|:---|:---|:---|:---|
| `cart_value` | number | Final value of cart after taxes, discounts, and coupons are applied. | [Get a cart](/docs/rest-storefront/carts#get-a-cart) <br> `cart_amount` |
...
| `channel_id` | string | The BigCommerce channel ID. Channel ID of the channel where checkout is taking place. | [Get all channels](/docs/rest-management/channels#get-all-channels) <br> `data.id` |
| `coupon_codes[]` | array of strings | Coupon codes applied to the purchase. | [Get a checkout](/docs/rest-management/checkouts#get-a-checkout) <br> `data.cart.coupons[].code` |
| `currency` | string | [ISO-4217 currency code](https://en.wikipedia.org/wiki/ISO_4217) of the order. | [Get a checkout](/docs/rest-management/checkouts#get-a-checkout) <br>  `data.cart.currency.code` |
| `event_id` | string | Unique ID for each event instance. | Unique event ID generated by BigCommerce. |
...
| `order_id` | string | Unique transaction ID generated by BigCommerce to prevent duplicate purchase records. | [Get a checkout](/docs/rest-management/checkouts#get-a-checkout) <br> `data.order_id` |
...
| `tax` | number | Tax incurred. | [Get a checkout](/docs/rest-management/checkouts#get-a-checkout) <br> `data.tax_total` |
...
| `category_names[]` | array | Category names. | [Get a product](/docs/rest-management/catalog/products#get-a-product) <br> `data.categories[]` |
...
| `discount` | number | Discount applied to purchase. | [Get a checkout](/docs/rest-management/checkouts#get-a-checkout) <br> `data.cart.discount_amount` |
| `product_id` | string | ID of the product. | [Get a product](/docs/rest-management/catalog/products#get-a-product) <br> `data.id` |
...
| `quantity` | number | Number of items of product purchased. | [Get a cart](/docs/rest-storefront/carts#get-a-cart) <br> `data.line_items.physical_items.quantity` or <br> `data.line_items.digital_items.quantity` |
...
| `variant_id` | integer | ID of the variant. | [Get a product](/docs/rest-management/catalog/products#get-a-product) <br> `data.variants.id` | 
