...
| `line_items.currency` | string | Currency of transaction. [ISO-4217 currency code](https://en.wikipedia.org/wiki/ISO_4217) | [Get a checkout](/api-reference/store-management/checkouts/checkout/checkoutsbycheckoutidget) <br>  `data.cart.currency.code`  | `items.currency` |
