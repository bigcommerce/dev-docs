...
BigCommerce offers a powerful cart recovery system to help retailers recover lost business by effectively converting abandoned carts into orders. Using BigCommerce's built-in [Abandoned Cart Saver](https://support.bigcommerce.com/s/article/Using-the-Abandoned-Cart-Saver?language=en_US) tool, retailers can automate email campaigns to encourage customers to complete transactions after leaving items in their cart.
