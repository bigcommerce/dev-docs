...
- `STORE_TOKEN|STORE_CLIENT`: For instructions on generating Store API credentials, visit [Obtaining Store API Credentials](/api-docs/getting-started/api-accounts#obtaining-store-api-credentials).
