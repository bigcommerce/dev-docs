...
- [API Reference > Store Management > Catalog > Product Metafields](/docs/rest-management/catalog/product-metafields)
- [API Reference > Store Management > Catalog > Product Variant Metafields](/docs/rest-management/catalog/product-variants-metafields)
