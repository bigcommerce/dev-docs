...
* [Product Metafields Endpoint](/docs/rest-management/catalog/product-metafields#create-a-product-metafield)
* [Variant Metafields Endpoint](/docs/rest-management/catalog/product-variants-metafields#create-a-product-variant-metafield)
...
## Resources
### Related endpoints
* [Product Metafield](/docs/rest-management/catalog/product-metafields#create-a-product-metafield)
* [Variant Metafield](/docs/rest-management/catalog/product-variants-metafields#create-a-product-variant-metafield)
### Related articles
