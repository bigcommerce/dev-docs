...
<Callout type="info">
You can use REST Storefront APIs if you are using a Stencil theme; see the [Working with the REST Storefront Cart an Checkout APIs](/api-docs/storefront/tutorials/working-sf-apis) tutorial for more information to build your headless site. 
</Callout>

This article assumes you are familiar with creating a channel and a site.
