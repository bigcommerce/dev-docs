...
<Callout type="info">
You can use REST Storefront APIs if you are using a Stencil theme; see the [Working with the REST Storefront Cart an Checkout APIs](/api-docs/storefront/tutorials/working-sf-apis) tutorial for more information, or use the [Storefront GraphQL APIs](/api-docs/storefront/graphql/carts-and-checkout) to build your headless site. 
</Callout>
