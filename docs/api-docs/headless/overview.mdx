...
<Tabs items={['Request', 'Response']}>
  <Tab>
    ...
    ```http {6-7} title="Example request, GraphQL Storefront" showLineNumbers copy
...
<Tabs items={['Request', 'Response']}>
  <Tab>
    ...
    ```http {6-7} title="Example request: Process a payment" showLineNumbers copy
