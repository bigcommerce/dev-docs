...
BigCommerce's [GraphQL Storefront API](docs/graphql-operations) makes it possible to query storefront data from a remote site. By leveraging the power of GraphQL, you can access product information for any product from any page.
