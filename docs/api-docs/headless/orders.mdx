...
* **Stored Card** – A shopper has authorized a retailer to store their payment details.
* **Credit Card** – A shopper has not authorized a retailer to store their payment details.
