...
* [Manage product data with the Catalog API](/docs/rest-catalog).
...
* [Process payments using the Payments API](/api-docs/store-management/payments-api-overview).
...
Using the [Catalog API](/docs/rest-catalog) you can return product data to your product details page and product listing page.
