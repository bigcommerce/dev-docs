...
-   Have a form to fill out for new users? We recommend auto-filling user input fields with data from the [Store Information API](/docs/rest-management/store-information), which already contains much of the info you might need from a new user.
...
![App Summary](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536259683439.png)
...
![App Summary Part Two](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536259722234.png)
...
![Details](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260365610.png)
...
![Legal Terms and Privacy Dev Tools](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260434551.png)
...
![Dev Tools App Screenshots](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260547856.png)
...
![Dev Tools Technical](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260547856.png)
...
![Dev Tool OAuth Scopes](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260600336.png)

### OAuth Scopes
If you know the [OAuth scopes](/api-docs/getting-started/api-accounts#oauth-scopes) that your app requires, you should select these. If you do not yet know the scopes that you need, you can just request minimal permissions (such as Information: Read-Only) to get started. However, once you determine the scopes you need, you must:
...
![Dev Tools App Testing](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260650757.png)
...
![Dev Tools Review](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536260677950.png)
...
![Dev Tools Preview](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536261272003.png)
...
![Dev Tools Payment](https://storage.googleapis.com/bigcommerce-production-dev-center/images/Partner%20Information/1536261347648.png)
...
## Resources
### Related Endpoints
* [Store Information API](/docs/rest-management/store-information)
