...
For up-to-date information about the latest releases, new features, and bug fixes, we recommend setting up [a feed alert](https://bcdevchangelog.noticeable.news/feeds) for the [Developer Changelog](/changelog). For more information, see [changelog](/api-docs/partner/getting-started/support#changelog).
