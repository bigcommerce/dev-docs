...
The [Checkout SDK](/stencil-docs/customizing-checkout/checkout-sdk) is a JavaScript library intended for partners, developers, and retailers who want to build a custom checkout front-end experience. To learn the basics about building a custom checkout directly into the control panel, see [Checkout SDK Quick Start](/stencil-docs/customizing-checkout/checkout-sdk-quickstart).
