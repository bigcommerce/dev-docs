...
2. In the control panel of your sandbox store, [create a store API account](/api-docs/getting-started/api-accounts#obtaining-store-api-credentials) and add the following OAuth scopes:
...
* [Create a Store API Account](/api-docs/getting-started/api-accounts#obtaining-store-api-credentials)
