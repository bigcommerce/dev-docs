...
2. In the control panel of your sandbox store, [create a store-level API account](/api-docs/getting-started/api-accounts#creating-store-level-api-accounts) and add the following OAuth scopes:
...
* [Create a Store-level API Account](/api-docs/getting-started/api-accounts#creating-store-level-api-accounts)
