...
Use [Handlebars expressions](/docs/rest-content/email-template-objects) to localize email templates and access dynamic data (like a customer's first name in an order email).
