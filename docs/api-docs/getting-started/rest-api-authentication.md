...
|:--------|:-----------|:----------|:------------|:----------|
| Content | modify | `store_v2_content` | View and modify store content | [/v2/pages](/docs/rest-content/store-content) <br>[/v2/blog](/docs/rest-content/store-content) <br>[/v2/redirects](/docs/rest-content/store-content) <br>/v3/widgets |
| Content | read-only | `store_v2_content_read_only` | View store content | [/v2/pages](/docs/rest-content/store-content) <br>[/v2/blog](/docs/rest-content/store-content) <br>[/v2/redirects](/docs/rest-content/store-content) <br>/v3/widgets |
| Checkout Content | modify | `store_content_checkout` | View and modify content on checkout pages | [/v3/scripts](/docs/rest-content/store-content) |
| Checkout Content | read-only | `store_content_checkout_read_only` | View content on checkout pages | [/v3/scripts](/docs/rest-content/store-content) |
| Customers | modify | `store_v2_customers` | View and modify customer information | [/v2/customers](/docs/rest-management/customers-v2) <br>[/v2/customer_groups](/docs/rest-management/customers-v2) <br>[/v3/customers/subscribers](/docs/rest-management/subscribers) <br>[/v3/customers/subscribers/wishlist](/api-reference/customer-subscribers/wishlist-api) |
| Customers | read-only | `store_v2_customers_read_only` | View customer information | [/v2/customers](/docs/rest-management/customers-v2) <br>[/v2/customer_groups](/docs/rest-management/customers-v2) <br>[/v3/customers/subscribers](/docs/rest-management/subscribers) <br>[/v3/customers/subscribers/wishlist](/api-reference/customer-subscribers/wishlist-api) |
...
| Marketing | modify | `store_v2_marketing` | View and modify marketing information | [/v2/coupons](/docs/rest-content/marketing) <br>[/v2/gift_certificates](/docs/rest-content/marketing) <br>[/v2/banners](/docs/rest-content/marketing) |
| Marketing | read-only | `store_v2_marketing_read_only` | View marketing information | [/v2/coupons](/docs/rest-content/marketing) <br>[/v2/gift_certificates](/docs/rest-content/marketing) <br>[/v2/banners](/docs/rest-content/marketing) |
| Orders | modify | `store_v2_orders` | View and modify orders | [/v2/orders](/docs/rest-management/orders) <br>[/v2/order_statuses](/docs/rest-management/orders) |
| Orders | read-only | `store_v2_orders_read_only` | View orders | [/v2/orders](/docs/rest-management/orders) <br>[/v2/order_statuses](/docs/rest-management/orders) |
| Order Transactions | modify | `store_v2_transactions` | View and modify order transactions | [/v3/orders/{id}/transactions](/docs/rest-management/transactions) |
| Order Transactions | read-only | `store_v2_transactions_read_only` | View order transactions | [/v3/orders/{id}/transactions](/docs/rest-management/transactions) |
...
| Get Payment Methods | read-only | `store_payments_methods_read` | Get a list of payment methods | [/payments](/docs/rest-payments/methods) |
| Products | modify | `store_v2_products` | View and modify products, brands, categories, and other product information. | [/v3/catalog](/docs/rest-management/catalog) <br>[/v3/pricelists](/api-reference/price-lists/pricelists-api) |
| Products | read-only | `store_v2_products_read_only` | View products | [/v3/catalog](/docs/rest-management/catalog) <br>[/v3/pricelists](/api-reference/price-lists/pricelists-api) |
| Themes | modify | `store_themes_manage` | View and modify themes | [/v3/themes](/docs/rest-content/themes) |
| Themes | read-only | `store_themes_read_only` | View themes | [/v3/themes](/docs/rest-content/themes) |
| Carts | modify | `store_cart` | View and modify carts | [/v3/carts](/docs/rest-storefront/carts) |
| Carts | read-only | `store_cart_read_only` | View carts | [/v3/carts](/docs/rest-storefront/carts) |
| Checkouts | modify | `store_checkout` | View and modify a checkout | [/v3/checkouts](/docs/rest-management/checkouts) |
| Checkouts | read-only | `store_checkout_read_only` | View checkout content | [/v3/checkouts](/docs/rest-management/checkouts) |
| Sites & Routes | modify | `store_sites` | View and modify sites and routes | [/v3/channels/{channel_id}/site](/docs/rest-management/sites) <br>[/v3/sites/{site_id}/routes](/docs/rest-management/sites) |
| Sites & Routes | read-only | `store_sites_read_only` | View external storefronts with non-BigCommerce URLs | [/v3/channels/{channel_id}/site](/docs/rest-management/sites) <br>[/v3/sites/{site_id}/routes](/docs/rest-management/sites) |
