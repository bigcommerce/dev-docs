...
* Within the [Developer Portal](/api-docs/getting-started/api-accounts#obtaining-app-api-credentials) workspace, you must enable your app’s **Technical** > **Multiple Users** option.
