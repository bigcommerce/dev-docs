...
|  [Product Videos](https://developer.bigcommerce.com/api-reference/store-management/catalog/product-videos/getproductvideos) | Create and manage product videos | `/catalog/products/{id}/videos` |
