...
| [Payments API](/api-docs/store-management/payments-api-overview) | [Create a payment access token](/docs/rest-payments/tokens#create-payment-access-token) | [Process a payment](/docs/rest-payments/processing#process-payment) | app or store | `PAT {{TOKEN}}` |
