...
|  [Payment Methods (deprecated)](/docs/rest-payments/methods-deprecated) | Create / manage enabled payment methods | `/payments/methods` |
...
* **V3** Brands, Categories, Products, and Product Variants expose a [metafields](/docs/rest-catalog/products/metafields#create-a-product-metafield) resource for use by developers to store custom data.
...
| --- | --- | --- |
|  [Brand Images](/docs/rest-catalog/brands/images) | Create and manage brand images | `/catalog/brands/{id}/images` |
|  [Brand Metafields](/docs/rest-catalog/brands/metafields) | Create and manage brand metafields | `/catalog/brands/{id}/metafields` |
|  [Brands](/docs/rest-catalog/brands) | Create and manage brands | `/catalog/brands` |
|  [Carts](/docs/rest-management/carts) | Create and manage store carts headlessly | `/carts` |
|  [Categories](/docs/rest-catalog/categories) | Create and manage categories | `/catalog/categories` |
|  [Category Images](/docs/rest-catalog/categories/images) | Create and manage category images | `/catalog/categories/{id}/images` |
|  [Category Metafields](/docs/rest-catalog/categories/metafields) | Create and manage category metafields | `/catalog/categories/{id}/metafields` |
...
|  [Payments - Get accepted methods](/docs/rest-payments/methods) | Get order payment methods for processing | `/payments/methods` |
|  [Payments - Create a payment access token](/docs/rest-payments/tokens) | Get an access token for payment processing | `/payments/accsess_tokens` |
...
|  [Products](/docs/rest-catalog/products) | Create and manage products | `/catalog/products` |
|  [Product Bulk Pricing Rules](/docs/rest-catalog/products/bulk-pricing-rules) | Create and manage product bulk pricing rules | `/catalog/products/{id}/bulk-pricing-rules` |
|  [Product Complex Rules](/docs/rest-catalog/products/complex-rules) | Create and manage product complex rules | `/catalog/products/{id}/complex-rules` |
|  [Product Custom Fields](/docs/rest-catalog/products/custom-fields) | Create and manage product custom fields | `/catalog/products/{id}/custom-fields` |
|  [Product Images](/docs/rest-catalog/products/images) | Create and manage product images | `/catalog/products/{id}/images` |
|  [Product Metafields](/docs/rest-catalog/products/metafields) | Create and manage product meta fields | `/catalog/products/{id}/metafields` |
|  [Product Modifier Images](/docs/rest-catalog/product-modifiers/images) | Create and manage product modifier images | `/catalog/products/{id}/modifiers/{id}/images` |
|  [Product Modifier Values](/docs/rest-catalog/product-modifiers/values) | Create and manage product modifier values | `/catalog/products/{id}/modifers/{id}/values` |
|  [Product Modifiers](/docs/rest-catalog/product-modifiers) | Create and manage product modifiers | `/catalog/products/{id}/modifiers` |
|  [Product Reviews](/docs/rest-catalog/products/reviews) | Create and manage product reviews | `/catalog/products/{id}/reviews` |
|  [Product Variant Metafields](/docs/rest-catalog/product-variants/metafields) | Create and manage product meta fields | `/catalog/products/{id}/variants/{id}/metafields` |
|  [Product Option Values](/docs/rest-catalog/product-variant-options) | Create and manage product variant option values | `/catalog/products/{id}/options/{id}/values` |
|  [Product Options](/docs/rest-catalog/product-variants) | Create and manage product variant options | `/catalog/products/{id}/options` |
|  [Product Variants](/docs/rest-catalog/product-variants) | Create and manage product variants | `/catalog/products/{id}/variants` |
|  [Product Videos](/docs/rest-catalog/products/videos) | Create and manage product videos | `/catalog/products/{id}/videos` |
...
|  [Variants](/docs/rest-catalog/product-variants) | Get and update all variants | `/catalog/variants` |
...
|  Resource               | Description                              | Endpoint                            |
|-------------------------|------------------------------------------|-------------------------------------|
|  [Payment Processing](/docs/rest-payments/processing) | Process payments on orders and checkouts | `payments.bigcommerce.com/stores/{store_hash}/payments` |

In addition to the payment processing API's `/payments` endpoint, there are two **V3** API endpoints related to payment processing. The first, [Create a payment access token](/docs/rest-payments/tokens#create-payment-access-token), is required to create an order-specific single-use token for authenticating payment processing requests. Requests to the second endpoint, [Get accepted payment methods](/docs/rest-payments/methods#get-accepted-payment-methods), are optional and can be used to retrieve an order's accepted payment methods, when necessary.

| Request                                   | Endpoint                                                                    |
|-------------------------------------------|-----------------------------------------------------------------------------|
| [Create a payment access token](/docs/rest-payments/tokens#create-payment-access-token)              | `api.bigcommerce.com/stores/{store_hash}/v3/payments/access_tokens` |
| [Get accepted payment methods](/docs/rest-payments/methods#get-accepted-payment-methods)    | `api.bigcommerce.com/stores/{store_hash}/v3/payments/methods`        |
...
|-|-|
|`/v2/brands`| [`/v3/catalog/brands`](/docs/rest-catalog/brands#get-all-brands)|
|`/v2/categories`| [`/v3/catalog/categories`](/docs/rest-catalog/categories#get-all-categories)|
...
|`/v2/products `| [`/v3/catalog/products`](/docs/rest-catalog/products#get-a-product)|
...
|`DELETE /v2/products`| May 10, 2020| [`DELETE /v3/catalog/products`](/docs/rest-catalog/products#delete-products)|
