...
| `DELETE Collection` [Products V2](/archive/store-operations/v2-catalog-products/v2-products) | [Products V3, Delete products](/docs/rest-catalog/products#delete-products) or individually, [Products V2, Delete a product](/legacy/v2-catalog-products/v2-products#delete-a-product) |
