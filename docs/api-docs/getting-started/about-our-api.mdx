...
### Storefront API
The [Storefront API](/docs/rest-storefront/carts) allows you to manage customer carts and checkouts and order information client-side. Some example uses of the Storefront API are:
...
### GraphQL API
BigCommerce's [GraphQL API](/docs/graphql-storefront) allows you to query product and customer data and store settings remotely or from a store's front end. Some use-case examples are:
...
| [Enabled Payment Methods](/docs/rest-payments/methods#get-all-payment-methods) | Get a list of available payment methods on a store. |
| Process Payments | Process payments on orders or checkouts. There are two APIs used to process payments. Get the [payment access token](/docs/rest-payments/processing) then [process the payment](/docs/rest-payments/methods).  |
...
| [Storefront GraphQL API](/docs/graphql-storefront) | Query storefront data from within a Stencil theme or remote site. |
