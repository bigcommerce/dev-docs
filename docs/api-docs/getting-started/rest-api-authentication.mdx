...
| Account | read-only | `parameter unavailable` | View account details | [GraphQL Users API Overview](/docs/graphql-users/overview) |
| Account Stores | read | `parameter unavailable` | View the stores associated with an account | [GraphQL Users API Overview](/docs/graphql-users/overview) |
| Account Apps | read | `parameter unavailable` | View the apps associated with an account | [GraphQL Users API Overview](/docs/graphql-users/overview) |
| Account Users | read | `parameter unavailable` | View the users associated with an account | [GraphQL Users API Overview](/docs/graphql-users/overview) |
| Account Users | write | `parameter unavailable` | Create and update users within an account| [GraphQL Users API Overview](/docs/graphql-users/overview) |
| Account Users | delete | `parameter unavailable` | Delete users within an account | [GraphQL Users API Overview](/docs/graphql-users/overview) |
