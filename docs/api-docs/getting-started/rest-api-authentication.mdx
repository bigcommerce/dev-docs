...
| Orders | modify | `store_v2_orders` | View and modify orders | [Orders V2](/api-reference/store-management/orders) <br />[Order Status V2](/docs/rest-management/orders/order-status#get-all-order-statuses) |
| Orders | read-only | `store_v2_orders_read_only` | View orders | [Orders V2](/api-reference/store-management/orders) <br />[Order Status V2](/docs/rest-management/orders/order-status#get-all-order-statuses) |
