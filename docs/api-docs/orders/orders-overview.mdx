...
* Access token for [API authentication](/api-docs/getting-started/api-accounts) with the following [scopes](/api-docs/getting-started/api-accounts#oauth-scopes):
  * Orders - **modify**
  * Products - **read-only**
