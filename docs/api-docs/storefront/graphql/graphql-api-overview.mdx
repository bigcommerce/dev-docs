...
Mutations have higher complexity than queries; you may only send one mutation in a single request. Pagination info and increases in query depth also contribute to complexity.
