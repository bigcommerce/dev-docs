...
You can access these attributes for a product if a retailer makes a product visible on storefronts.

This guide walks you through the process of retrieving information for a product. If your product has variants, see [Guide to Working with Product Variants](/api-docs/storefront/graphql/variants) on how to retrieve variant information. For full schema documentation, see the [GraphQL Storefront Playground](https://developer.bigcommerce.com/graphql-storefront/playground).
...
<Callout type="information">
  ...
  See [Get a variant](/api-docs/storefront/graphql/variants#get-a-variant) for more information.
</Callout>
...
Query the [product options](/docs/rest-catalog/product-variant-options) associated with a product. The response includes both variant options and modifier options. To retrieve only variant options, use a [Get variant options](/api-docs/storefront/graphql/variants#get-variant-options) query. 
...
<Callout type="information">
  ...
  The query retrieves only **product** metafields. To retrieve **variant** metafields, see [Get variant metafields](/api-docs/storefront/graphql/variants#get-variant-metafields). 
</Callout>
...
Query reviews for products. You retrieve only reviews that a retailer has approved. The following example retrieves the first review for the specified product: 
...
- [Guide to Working with Product Variants](/api-docs/storefront/graphql/variants)
...
- [Catalog API- Get product metafields](/api-docs/storefront/graphql/products#get-product-metafields) endpoint
- [Catalog API- Get variant metafields](/api-docs/storefront/graphql/variants#get-variant-metafields) endpoint
