...
Web pages, the main blog index page, and blog posts can be retrieved using the web page URL.

The following query retrieves info for the page with the given path URL. 
