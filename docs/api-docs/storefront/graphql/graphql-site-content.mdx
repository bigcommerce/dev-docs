...
- Retrieve rendered [widgets](https://support.bigcommerce.com/s/article/Page-Builder?language=en_US#builder) built using Page Builder or [Widgets API](https://developer.bigcommerce.com/api-docs/store-management/widgets/widgets-overview)
...
# The response orders web pages ordered by entityId, with the lowest IDs returned first
...
The following example retrieves rendered widgets on plain-text pages. This will return the rendered HTML content of any widgets which have [Placements](https://developer.bigcommerce.com/api-docs/store-management/widgets/tutorials/widgets-tutorial#create-a-placement) in a given page's Regions.
...
Queries return only visible [banners](https://support.bigcommerce.com/s/article/Creating-Editing-Banners?language=en_US).
