...
Developers can use frontend GraphQL to query the following: 

- [Web page content]((https://support.bigcommerce.com/s/article/Web-Pages?language=en_US)), including those created from the WYSIWYG editor, contact forms, blog pages, and blog posts
- [Banner content](https://support.bigcommerce.com/s/article/Creating-Editing-Banners?language=en_US) on home, search, category, and brand pages 
- [Widgets](https://support.bigcommerce.com/s/article/Page-Builder?language=en_US#builder) rendered on web pages
...
Contact form pages and web pages created from the WYSIWYG editor can be retrieved using the web page URL.
