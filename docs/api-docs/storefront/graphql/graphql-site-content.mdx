...
- [Web page content]((https://support.bigcommerce.com/s/article/Web-Pages?language=en_US)), including WYSIWYG pages, contact forms, blog pages, and blog posts
...
- [Widgets](https://support.bigcommerce.com/s/article/Page-Builder?language=en_US#builder) rendered on web pages, including WYSIWYG pages, contact forms, blog, and blog posts


## Web pages

Queries for web pages retrieve webpages for a specific storefront. The request URL contains the storefront domain. For example, to retrieve webpages from the `yourstore.example.com` storefront domain, send a request to the URL `https://{yourstore.example.com}/graphql`. If the request URL uses the permanent store URL, the query returns webpages from the default storefront channel.
