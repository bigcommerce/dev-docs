...
For more information on formatting the request payload, see [the query example section of the GraphQL Storefront API Overview](/api-docs/storefront/graphql/graphql-storefront-api-overview#querying-within-a-bigcommerce-storefront).
