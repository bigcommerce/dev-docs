# GraphQL Carts and Checkout

BigCommerce's GraphQL Storefront API now supports Cart and Checkout objects within the graph. This Cart and Checkout support offers similar benefits as our REST APIs, but having Cart and Checkout in GraphQL alongside other data makes it easier for building storefront functionality.

The addition of GraphQL now means we have all the critical GraphQL capabilities necessary to power an end-to-end shopper purchase funnel in GraphQL, inclusive of:
