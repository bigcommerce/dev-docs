...
```json filename="Example response: Create a widget" showLineNumbers
{
  "data": {
    "channel_id": 1,
...
```http filename="Example request: Place a widget" showLineNumbers
...
```http filename="Example request: Update a widget template" showLineNumbers
