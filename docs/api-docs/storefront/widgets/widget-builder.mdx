...
* A [store-level or app-level API account](/api-docs/getting-started/api-accounts) with the following OAuth scopes:
...
For more information on authentication, see [Authentication](/api-docs/getting-started/authentication).
...
If you're interested in making your widgets available for download or sale on other stores, check out the [BigCommerce App Marketplace](https://www.bigcommerce.com/apps/categories/site-tools/tools-widgets/) and learn about [becoming a partner developer](/api-docs/partner/becoming-a-partner).
