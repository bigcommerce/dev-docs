...
Widgets are configurable and reusable components of content that retailers can display on their storefront. Widgets consist of a combination of HTML/CSS, JavaScript, and Handlebars, and are rendered as part of the storefront’s HTML.
...
* API OAuth [access token](/api-docs/getting-started/api-accounts) with the OAuth **Content** scope set to **modify**.
