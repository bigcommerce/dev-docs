...
* API OAuth [access token](/api-docs/getting-started/authentication/api-accounts) with the OAuth **Content** scope set to **modify**.
...
Take note of the widget's `uuid` returned in the [response](/api-reference/store-management/widgets/widget/createwidget#responses). You will need the widget's `uuid` to [create a placement](/docs/rest-content/widgets/widget#create-a-widget) for your widget.
