...
You can further narrow the scope of a zone by specifying one or more customer groups to whom the zone applies. The Price Lists API lets you use tax zones to modify how a store displays prices to different customer groups.  
