...
You can further narrow the scope of a zone by specifying one or more customer groups to whom the zone applies. Using tax zones, you can choose how a store displays prices to customer groups to whom a zone applies, for example, whether prices are inclusive or exclusive of tax.  
