...
This tutorial demonstrates how to build and embed a BigCommerce app using Nodejs, React, Next.js, and BigDesign, BigCommerce's library of React components. 
...
* Experience with [Nodejs](https://nodejs.org/en/), [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript), and [React](https://www.reactjs.org/)
