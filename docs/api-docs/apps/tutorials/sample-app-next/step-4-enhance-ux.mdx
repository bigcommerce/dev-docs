...
```ts file="Add imports list.ts" showLineNumbers copy
...
```ts file="Add logic list.ts" showLineNumbers copy
...
```ts file="Add isLoading hooks.ts" showLineNumbers copy
...
```ts file="Add useProductList hooks.ts" showLineNumbers copy
...
```ts file="Add imports index.tsx" showLineNumbers copy
...
```ts file="Add imports innerHeader.tsx" showLineNumbers copy
...
```tsx file="Functional component innerHeader.tsx" showLineNumbers copy
const InnerHeader = () => {
    const router = useRouter();
...
```ts file="Add imports header.tsx" showLineNumbers copy
...
```ts file="Declare variables header.tsx" showLineNumbers copy
export const TabIds = {
    HOME: 'home',
    PRODUCTS: 'products',
};
...
```tsx file="Functional component error.tsx" showLineNumbers copy
...
```tsx file="Functional component loading.tsx" showLineNumbers copy
...
```tsx file="System check components index.tsx" showLineNumbers copy
...
```ts file="Export types data.ts" showLineNumbers copy
...
```ts file="Add imports form.tsx" showLineNumbers copy
...
```ts file="Define FormProps form.tsx" showLineNumbers copy
interface FormProps {
    formData: FormData;
    onCancel(): void;
...
```ts file="Declare FormErrors form.tsx" showLineNumbers copy
const FormErrors = {
...
```tsx file="Functional component form.tsx" showLineNumbers copy
...
```ts file="Add imports [pid].tsx" showLineNumbers copy
import { useRouter } from 'next/router';
import ErrorMessage from '../../components/error';
...
```tsx file="Functional component ProductInfo [pid].tsx" showLineNumbers copy
const ProductInfo = () => {
    const router = useRouter();
    const encodedContext = useSession()?.context;
    const { pid } = router.query;
...
```ts file="Add imports [pid].ts" showLineNumbers copy
import { NextApiRequest, NextApiResponse } from 'next';
import { bigcommerceClient, getSession } from '../../../lib/auth';
```
...
```ts file="Update handler logic [pid].ts" showLineNumbers copy
...
```tsx file="Extend Box styles index.tsx" showLineNumbers copy
