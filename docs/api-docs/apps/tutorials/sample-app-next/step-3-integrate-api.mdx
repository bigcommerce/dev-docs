...
Whether you're using Firebase or MySQL, set up the initial tables or collections by navigating to the root directory of your project and running the following script:
