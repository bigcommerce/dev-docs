...
```ts file="Export types auth.ts" showLineNumbers copy
...
```ts file="Export types db.ts" showLineNumbers copy
...
```ts file="Add exports index.ts" showLineNumbers copy
export * from './auth';
export * from './db';
```
...
```tsx file="Add context logic session.tsx" showLineNumbers copy
...
```shell copy file="Add JWT secret"
JWT_KEY={SECRET}
```
...
```ts file="Add imports auth.ts" showLineNumbers copy
...
```ts file="Export client config auth.ts" showLineNumbers copy
...
```ts file="Remove QueryParams auth.ts" showLineNumbers copy
//Delete this code
...
```ts file="Export JWT handling auth.ts" showLineNumbers copy
...
```ts file="Export sessions auth.ts" showLineNumbers copy
...
```ts file="Export payload functions auth.ts" showLineNumbers copy
...
```shell copy file="Add environment variables Firebase"
DB_TYPE=firebase
```

2. Enter your Firebase database config keys.

```shell copy file="Add environment variables Firebase" showLineNumbers copy
...
```ts file="Add imports firebase.ts" showLineNumbers copy
...
```ts file="Add config firebase.ts" showLineNumbers copy
...
```ts file="Add imports mysql.ts" showLineNumbers copy
...
```ts file="Add config mysql.ts" showLineNumbers copy
const MYSQL_CONFIG = {
...
```ts file="Add config db.ts" showLineNumbers copy
...
```ts file="auth.ts" showLineNumbers copy
import { NextApiRequest, NextApiResponse } from 'next';
...
```ts file="Add config auth.ts" showLineNumbers copy
...
```ts file="Add imports load.ts" showLineNumbers copy
import { NextApiRequest, NextApiResponse } from 'next';
...
```ts file="Add config load.ts" showLineNumbers copy
...
```ts file="Add imports uninstall.ts" showLineNumbers copy
import { NextApiRequest, NextApiResponse } from 'next';
...
```ts file="Add config uninstall.ts" showLineNumbers copy
...
```ts file="index.ts" showLineNumbers copy
import { NextApiRequest, NextApiResponse } from 'next';
...
```ts file="Add products function index.ts" showLineNumbers copy
...
```ts file="Add imports hooks.ts" showLineNumbers copy
...
```ts file="Declare fetcher hooks.ts" showLineNumbers copy
...
```ts file="Export useProducts hooks.ts" showLineNumbers copy
// Reusable SWR hooks
...
```tsx file="Add imports header.tsx" showLineNumbers copy
...
```tsx file="Functional component header.tsx" showLineNumbers copy
const Header = () => (
...
```tsx file="Add imports index.tsx" showLineNumbers copy
...
```tsx file="Functional component index.tsx" showLineNumbers copy
const Index = () => {
...
```tsx file="_app.tsx" showLineNumbers copy
...
```tsx file="SessionProvider _app.tsx" showLineNumbers copy
<SessionProvider>
  <Component {...pageProps} />
</SessionProvider>
```
...
```tsx file="Add Box _app.tsx" showLineNumbers copy
