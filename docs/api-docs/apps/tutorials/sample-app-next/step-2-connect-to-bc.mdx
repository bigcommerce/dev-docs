...
6. Because you will be modifying the Products API resource, set the Products OAuth scope to **MODIFY**. To learn more about the available OAuth scopes, see [OAuth scopes](/api-docs/getting-started/api-accounts#oauth-scopes).
...
[Next: Integrate the BigCommerce API and Add a Database](/api-docs/apps/tutorials/build-a-nextjs-sample-app/step-3-integrate)
