...
Once you obtain the app ID, you can use it to create or modify the app configuration for a channel using the [Create a channel](/api-reference/store-management/channels/channels/createchannel) or [Update a channel](/api-reference/store-management/channels/channels/updatechannel) endpoint.
