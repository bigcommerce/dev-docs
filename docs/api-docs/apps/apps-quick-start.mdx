...
7. To set up the initial tables or collections, navigate to the root directory of your project and run the database migration using the following npm script:
