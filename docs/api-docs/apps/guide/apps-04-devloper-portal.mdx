...
Creating an app also creates an app API account. To learn more about app API accounts, see the [Guide to API Accounts](/api-docs/getting-started/api-accounts#app-api-accounts). To create an app, do the following:
