...
* Approval for the [Marketplace](https://www.bigcommerce.com/apps/) requires all fields listed in the **Publishing App** section (**Case Studies** and **Videos** are optional).
