...
- Use BigCommerce APIs for app functionality wherever possible. For example, don't require a retailer to manually import a product CSV if those products can be retrieved using the BigCommerce API.
