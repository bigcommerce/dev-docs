...
```http filename="Example request: Filter by log ID" showLineNumbers
...
```json filename="Example response: Filter by log ID" showLineNumbers
{
  "data": [
    {
      "id": 5,
...
```http filename="Example request: Filter by type" showLineNumbers
...
```json filename="Example response: Filter by type" showLineNumbers
{
  "data": [
    {
      "id": 6,
...
```http filename="Example request: Filter by module" showLineNumbers
...
```json filename="Example response: Filter by module" showLineNumbers
{
  "data": [
    {
      "id": 92,
...
```http filename="Example request: Filter by severity" showLineNumbers
...
```json filename="Example response: Filter by severity" showLineNumbers
{
  "data": [
    {
      "id": 3,
...
```http filename="Example request: Filter with pagination" showLineNumbers
...
```json filename="Example response: Filter with pagination" showLineNumbers
{
  "data": [
    {
      "id": 3,
