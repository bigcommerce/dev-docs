...
| Tax provider inks to display in control panel                  | Optional                       | URL, Title, Description                          | Link(s) displayed to shoppers when they navigate to **Store Setup > Tax > {Tax Provider}**. One or multiple links supported.                        | `support.sampletax.com`, `Sample Tax Support`, `The Sample Tax Support website.`                    |
| **Coverage**                          |                                |                              |                                                                                                       |                                                   |
