...
For more information on this step, see [Update the customer settings per channel](/docs/rest-management/customers/customer-settings-channel#update-customer-settings-per-channel).
