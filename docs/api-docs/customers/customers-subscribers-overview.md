...
[Password confirmation](/docs/rest-management/customers-v2#create-a-new-customer) and [validation](/docs/rest-management/customers-v2/customer-passwords#validate-a-password) are still available under the V2 Customers API. 
