...
[Password confirmation](/api-reference/customer-subscribers/customers-api/customers/createanewcustomer) and [validation](/docs/rest-management/customers-v2/customer-passwords#validate-a-password) are still available under the V2 Customers API. 
