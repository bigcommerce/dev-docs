...
<Callout type="info">
 #### API account notes
 * This endpoint requires **app-level API account** credentials. For more information about generating accounts, consult the [Guide to API Accounts](/api-docs/getting-started/api-accounts#app-level-api-accounts).
...
To create a JWT, you need to get a `customer_id` using the [Customers V3 API]((/docs/rest-management/customers).
...
### Articles
* [Authenticating BigCommerce’s REST APIs](/api-docs/getting-started/authentication)
* [BigCommerce APIs Quick Start](/api-docs/getting-started/making-requests)
* [Creating App-level API Accounts](/api-docs/getting-started/api-accounts#creating-app-level-api-accounts)
