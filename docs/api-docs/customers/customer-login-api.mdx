...
<Callout type="info">
You can also use the [GraphQL Storefront API](/api-docs/storefront/graphql/graphql-storefront-api-overview#customer-login) to manage access to a shopper's account.
</Callout>
