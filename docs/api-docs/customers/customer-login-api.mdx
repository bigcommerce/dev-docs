...
* [Authenticating BigCommerce’s REST APIs](/api-docs/getting-started/api-accounts#choosing-the-right-kind-of-api-account)
* [BigCommerce APIs Quick Start](/archive/start/making-requests)
* [Introduction to JSON Web Tokens](https://jwt.io/introduction/)

### Endpoints

* [Customer Login SSO](/docs/storefront-auth/customer-login)
