...
<Callout type="info">
You can also use the [GraphQL Storefront API](/api-docs/storefront/graphql/graphql-storefront-api-overview#customer-login) to authorize your application to work with customer-specific storefront data.  
</Callout>
