...
<Callout type="info">
#### API account notes
- This endpoint requires **app API account** credentials. For more information about generating accounts, consult the [Guide to API Accounts](/api-docs/getting-started/api-accounts#app-level-api-accounts).
