...
[Products](/docs/rest-management/catalog/products) are the primary catalog entity, and the primary function of the ecommerce platform is to sell products on the storefront and other channels.
...
<Callout type="info">
  ...
  * You can also add images to [variants](/docs/rest-management/catalog/product-variants).
</Callout>
...
[Metafields](/docs/rest-management/catalog/product-metafields) are key-value pairs intended for programmatically storing data against a product or other entity. Data stored in metafields does not appear in the storefront or the control panel. Data not appearing in the storefront or control panel is useful when information needs to be passed back and forth between an app and BigCommerce.
...
* Are auto-generated from variants when you create a product with variants using the [Create a product](/docs/rest-management/catalog/products#create-a-product) endpoint
...
<Callout type="info">
  ...
  Creating a variant option does not automatically create SKUs or build out variants. You can build out SKUs later using the [Create product variants](/docs/rest-management/catalog/product-variants#create-a-product-variant) endpoint.
</Callout>
