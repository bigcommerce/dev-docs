...
keywords: products, get all products, get products
---
...
[Product Sort Order](/docs/rest-catalog/products/sort-order#get-product-sort-order) allows you to manage the sort order of products displayed on any given category page. Products assigned to multiple storefront categories can have different sort order values per category.
