...
V3 Catalog introduced a new option model that included two types of options: [variant options](/docs/store-operations/catalog#variant-options) and [modifiers](/api-docs/store-management/catalog/catalog-overview#modifier-options). 
