...
Consult the [Payments API Reference](/docs/rest-payments/processing/process-payment) to determine which OAuth permission scopes your application's [API Account](/api-docs/getting-started/api-accounts) needs.
