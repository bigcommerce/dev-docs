...
2. [Create Access Token](/docs/rest-payments/tokens#create-payment-access-token)
...
2. Make a request to [Create Access Token](/docs/rest-payments/tokens#create-payment-access-token) to get the authorization token that needs to be passed in the header when processing the payment. The ID of the order needs to be part of the request body.
...
1. [Create Access Token](/docs/rest-payments/tokens#create-payment-access-token)
...
1. Make a request to [Create Access Token](/docs/rest-payments/tokens#create-payment-access-token) to get the authorization token that needs to be passed in the header when processing the payment. The ID of the order needs to be part of the request body.
...
| `30051` | That stored payment instrument could not be found. Please try a different payment option. |  The card requested for payment is not associated to the shopper.| Use [Get Payment Methods](/docs/rest-payments/methods#get-accepted-payment-methods) to see available vaulted cards |
...
### Endpoints
* [Create Access Token](/docs/rest-payments/tokens#create-payment-access-token)
