...
`customer_id:0`or leaving it blank. After the order is created, then follow the steps for either a [credit card](#credit-cards) or a [stored card](#payments_stored-cards).
