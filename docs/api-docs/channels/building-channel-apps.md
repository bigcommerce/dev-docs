...
```http filename="Example request: Create a product" showLineNumbers
...
```http filename="Example request: Get all products" showLineNumbers
...
```http filename="Example request: Create channel listings" showLineNumbers
...
```http filename="Example request: Create an order" showLineNumbers
