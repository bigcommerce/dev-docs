...
- More seamless integration within the BigCommerce control panel that looks and feels native due to following BC patterns and being more deeply integrated within core parts of the BC control panel
