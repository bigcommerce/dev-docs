...
| store/channel/{channel_id}/settings/currency/updates | Fires when   | [Update a Currency](https://developer.bigcommerce.com/api-reference/c5115f9abdacc-update-a-currency)|
