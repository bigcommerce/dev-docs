...
| Name / Scope | Description | Corresponding Endpoint |
|:-------------|:------------|:-----------------------|
| `store/channel/metafield/created/` | Fires when a metafield is created per a specified channel. |  
| `store/channel/metafield/deleted`  | Fires when a metafield is deleted per a specified channel. |  |
| `store/channel/metafield/updated`  | Fires when a metafield is updated per a specified channel. |  |
...
```json filename="Example metafields payload object" showLineNumbers copy
{
 ...
 "producer": "stores/abcde",
 "created_at": 1641641646,
 "scope": "store/channel/1/metafields/updated",
 "data": {},
 "hash": "3f9ea420af83450d7ef9f78b08c8af25b2213637"
}
```
