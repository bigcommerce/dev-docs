...
Run `npm install @bigcommerce/checkout-sdk@<latest/version number>` in your terminal.

OR

You can open your store's `package.json` file in your text editor.
