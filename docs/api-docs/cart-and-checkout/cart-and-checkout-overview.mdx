...
***Resolution:***
To get the correct `option_id`, make a request to [Get Products](/docs/rest-management/catalog/products) or [Get Options](/api-reference/catalog/catalog-api/product-options/getoptions).
