...
```js filename="Log cart details to the console" showLineNumbers
...
```js filename="Log order details to the console" showLineNumbers
...
```html filename="Log order details to the console" showLineNumbers
<script>
...
```json filename="Single modifier" showLineNumbers
{
  "line_items": [
    {
      "quantity": 1,
...
```json filename="Single option" showLineNumbers
{
  "line_items": [
    {
      "quantity": 1,
...
```json filename="Modifier and option" showLineNumbers
{
  "line_items": [
    {
      "quantity": 1,
...
```json filename="Create cart with modifier" showLineNumbers
{
  "line_items": [
    {
      "quantity": 1,
...
```json filename="Create cart with customer ID" showLineNumbers
{
  "customer_id": 12,
  "line_items": [
    {
...
```json filename="Create cart with variant ID" showLineNumbers
{
  "line_items": [
    {
      "quantity": 1,
...
```json filename="Create cart option ID" showLineNumbers
{
  "line_item": {
    "quantity": 1,
    "product_id": 76,
...
```json filename="Create cart optionId and optionValue" showLineNumbers
{
  "lineItems": [
    {
      "quantity": 1,
...
```json filename="Create Storefront Cart variantID" showLineNumbers
{
  "lineItems": [
    {
      "quantity": 1,
...
```json filename="Add item with option and modifier" showLineNumbers
{
  "lineItems": [
    {
      "quantity": 1,
