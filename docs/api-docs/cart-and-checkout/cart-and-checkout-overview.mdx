...
The Server-to-Server APIs manage the contents of a shopping cart and checkout remotely from a server. The Cart, Checkout, and Payment APIs allow for a fully headless ecommerce solution.
