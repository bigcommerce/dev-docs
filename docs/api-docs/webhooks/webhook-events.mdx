...
| <sup>+</sup>store/sku/inventory/updated | Fires to indicate changes in variant inventory. The webhook fires only for products with variants. To fire the webhook, you must track by _variant_ and change _variant-level_ inventory. |
| <sup>++</sup>store/sku/inventory/order/updated | Fires to indicate changes in variant inventory through an order. The webhook fires only for products with variants, and you must track by variant. |
