...
| store/order/metafield/updated| Fires when an already created order metafield is updated. Any changes to an existing order metafield will fire this webhook.|
...
```json filename="Example product variant payload object" showLineNumbers copy
{
    "producer": "stores/{store_hash}",
    "hash": "60f42bd247b52f0647cbd16b1205c84260287141",
    "created_at": 1683305167,
