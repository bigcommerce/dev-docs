...
|:------------------------|:------------|
| store/brand/metafield/* | Subscribe to all brand events. |
...
```json filename="Example brand created payload object" showLineNumbers copy
{
...
```json filename="Example cart metafield payload object" showLineNumbers copy
...
| store/category/metafield/created | Category metafield is created. |
| store/category/metafield/deleted | Category metfield is deleted. |
| store/category/metafield/updated | Category metafield is updated. |
...
```json filename="Example category metafield payload object" showLineNumbers copy
{
...
| Name / Scope             | Description |
|:-------------------------|:------------|
| store/inventory/location/metafield/*        | Subscribe to all store/inventory/location/metafields events.  |
| store/inventory/location/metafield/created  | This webhook will fire whenever a new inventory, location metafield is created.  |
| store/inventory/location/metafield/deleted  | When a inventory, location metafield is deleted. |
